...
export default class App {
  constructor() {
    ...
    this.addShot("Ethiopia Yirgacheffe", 18, 36, 28,"neu");
  ...
  addShot(bean, input, output, time, notes = "") {
    ...
    let category = "ok";
    if (ratio >= 1.8 && ratio <= 2.2 && time >= 25 && time <= 35) category = "good";
    else if (ratio < 1.5 || ratio > 2.5 || time < 20 || time > 40) category = "bad";
